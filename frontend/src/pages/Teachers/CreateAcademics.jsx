...
import { useCreateAcademicGuidanceMutation } from "../../redux/api/blog";

const CreateAcademics = () => {
  const [createAcademicGuidance] = useCreateAcademicGuidanceMutation();
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Sending data to API using RTK Query mutation
      await createAcademicGuidance(academicData).unwrap(); // Using unwrap() to handle the response directly
